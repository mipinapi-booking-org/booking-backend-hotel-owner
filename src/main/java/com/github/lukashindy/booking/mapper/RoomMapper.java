...
public interface RoomMapper {
    ...
    @Mapping(source = "roomType.capacity", target = "roomTypeCapacity")
    @Mapping(source = "hotel.id", target = "hotelId")
    @Mapping(source = "hotel.name", target = "hotelName")
    @Mapping(source = "hotel.city", target = "hotelCity")
    @Mapping(source = "hotel.country", target = "hotelCountry")
    RoomWithDetailsDto toDetailedDto(Room entity);
